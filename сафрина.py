...
if a_list!=[]:
    ...
    a_df = pd.DataFrame(a_s)
    with st.expander("Аппроксимация без использования сплайнов"):
    ...
    with st.expander("Аппроксимация с двумя сплайнами, точка соединения которых найдена с помощью метода"):
    ...
    with st.expander("Аппроксимация с тремя сплайнами, точки соединения которых найдены с помощью метода"):
        st.write('Полученные значения для первой части:')
        st.write('по МНК:        а_0 =', x_1_mnk[0], ', а_1 =', x_1_mnk[1])
        st.write('уравнение: y_t =', x_1_mnk[0], '+', x_1_mnk[1], '*t')
        st.write('по Чебышеву:   а_0 =', x_1_cheb[0], ', а_1 =', x_1_cheb[1])
    ...
    with st.expander("Аппроксимация с двумя сплайнами с наилучшим R^2"):
        st.write('Полученные значения для первой части:')
